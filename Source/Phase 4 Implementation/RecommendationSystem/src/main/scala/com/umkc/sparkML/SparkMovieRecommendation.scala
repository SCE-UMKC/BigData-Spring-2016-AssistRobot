...
object SparkMovieRecommendation {
  def main(args: Array[String]) {
    ...
    val movies = sc.textFile(new File(movieLensHomeDir, "location.dat").toString).map { line =>
      val fields = line.split("::")
    ...
    println("Got " + numRatings + " ratings from "
      + numUsers + " users on " + numMovies + " objectlocations.")
    ...
    println("possible locations for finding objects that are recommended for you:")
